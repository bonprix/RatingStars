...
public class RatingStars extends AbstractField<Double> implements Comparable<RatingStars> {
    ...
    /**
     * Constructs a new animated RatingStars component with default value of 0.0 and default maximum value of five.
     *
     * @see #setMaxValue(int)
    ...
    /**
     * Sets the maximum value (rating) the user can give. The default value is five.
     *
     * @param maxValue
     */
    ...
    /**
     * Sets whether the client-side transitions should be animated or not. The default value is <code>true</code>.
     *
     * @param animated should the client-side transitions be animated
     */
    ...
    @Override
    public int compareTo(final RatingStars o) {
     ...
     */
    public void setValueCaption(final int value, final String captionForValue) {
        getState().valueCaptions.put(value, captionForValue);
    }

    /**
     * Sets all given captions as displayed descriptions for rating values in sequence starting from 1.
     *
     * @param captionsForValues
     * @see #setValueCaption(int, String)
     */
    public void setValueCaption(final String... captionsForValues) {
        int value = 1;
        for (final String caption : captionsForValues) {
